...
@section('content')
    <div class="layout-content">
        ...
        <div class="container-fluid flex-grow-1 container-p-y">
            <h4 class="font-weight-bold py-3 mb-0">Khóa học</h4>
            ...
            <div class="card mb-4">
                <h6 class="card-header">Thêm khóa học</h6>
                <div class="card-body">
                    <form>
                        <div class="form-row">
                ...
                <div class="card-body">
                    <form>
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">Your password must be 8-20 characters long, contain letters
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <small class="valid-feedback">A block of help text that breaks onto a new line and may extend
                    ...
                    <div class="form-group">
                        ...
                        <small class="invalid-feedback">A block of help text that breaks onto a new line and may extend
                            beyond one line.</small>
                    </div>
        ...
        <nav class="layout-footer footer bg-white">
            <div class="container-fluid d-flex flex-wrap justify-content-between text-center container-p-x pb-3">
                <div class="pt-3">
                    <span class="footer-text font-weight-semibold">© <a href="https://srthemesvilla.com"
